    ...
    <section className="py-24 bg-brand">
      <div className="max-w-6xl mx-auto px-5 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/onboard"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl text-base font-bold bg-white text-brand hover:bg-surface transition-all duration-150 shadow-lg hover:shadow-xl"
          >
